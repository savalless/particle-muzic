...
from phenomena.particles.kinematics.collision.inverse_decay_list import InverseDecayList
...
class CollisionChannel(object):
    ...
    def _set_virtual_data(self,virtual_list,p1,p2):
        ...
        for particle in virtual_list:
            ...
            for option in decay:
                if pythia._particle_data.name2id(p1) and pythia._particle_data.name2id(p2) in option[1]:
